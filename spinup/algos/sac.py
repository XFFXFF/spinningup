...
class TD3Agent(object):
    ...
    def __init__(self,
        ...
        v_loss = tf.reduce_mean((self.v - y_v)**2)
        self.train_v_op = tf.train.AdamOptimizer(v_lr).minimize(v_loss)
    ...
    def update_v(self, feed_dict):
        self.sess.run(self.train_v_op, feed_dict=feed_dict)
